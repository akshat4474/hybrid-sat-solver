...
class SolverController:
    ...
    def run_cdcl(self) -> bool:
        ...
        self.log_result("CDCL", start_time, "success" if success else "failure")
        return success
    ...
    def run_walksat(self, max_flips=10000) -> bool:
        ...
        self.log_result("WalkSAT", start_time, "success" if success else "failure")
        return success
    ...
    def run_brute_force(self) -> bool:
        ...
        self.log_result("Brute Force", start_time, "success" if success else "failure")
        return success
